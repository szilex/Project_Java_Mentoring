...
public interface IMeetingService {
    ...
    MeetingDetails saveMeeting(MeetingDetails meetingDetails) throws UserNotFoundException;
    MeetingDetails updateMeeting(MeetingDetails meetingDetails) throws UserNotFoundException, MeetingNotFoundException;
